  ...
  return (
    <section id="tarifs" className="py-20 bg-[#F5F7F6]">
      <div className="container mx-auto px-4">
          ...
          <Card className="rounded-2xl shadow-lg bg-white relative">
            <CardHeader className="text-center pt-8">
              ...
              <div className="space-y-2">
                ...
                <div className="text-lg text-gray-600">Payable par an : 420 DT/an</div>
              </div>
            </CardHeader>
          ...
          <Card className="rounded-2xl shadow-lg bg-white relative border-2 border-[#6A9C89]">
            ...
            <CardHeader className="text-center pt-8">
              ...
              <div className="space-y-2">
                ...
                <div className="text-lg text-gray-600">Payable par an : 540 DT/an</div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="text-center mb-6">
        ...
        {/* Note sur le paiement annuel */}
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 text-red-600 mb-2">
                <span>♦</span>
                <span className="font-medium">Tous les plans sont payables annuellement.</span>
              </div>
