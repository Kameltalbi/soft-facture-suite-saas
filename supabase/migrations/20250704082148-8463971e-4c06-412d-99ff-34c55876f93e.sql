-- Mettre à jour la fonction check_plan_limits pour corriger les limites d'utilisateurs
  ...
  CASE limit_type
    WHEN 'max_users' THEN
      RETURN CASE user_plan 
        WHEN 'essential' THEN 2  -- 2 utilisateurs pour le plan essential
        WHEN 'pro' THEN 10       -- 10 utilisateurs pour le plan pro
        ELSE 0
      END;
