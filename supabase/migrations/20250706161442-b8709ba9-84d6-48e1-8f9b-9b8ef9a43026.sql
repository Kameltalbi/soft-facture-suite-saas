-- Corriger la fonction handle_new_user pour créer les organisations avec le statut 'pending' par défaut
...
BEGIN
  ...
  ELSE
    ...
    VALUES (
      ...
      'pending', -- Statut par défaut pour validation par superadmin
